...
export default class EsperienzeLavorative extends React.Component{
  render(){
    return(
      <div className="App">
        <NavigatorBar />
        ...
        <div className='testoPage'>
          <ul className="listeVarie">
            <li>Sviluppo <a href="talianiferroshop.com">talianiferroshop.com</a> (realizzato con Shopify)</li>
        ...
        <div className='testoPage'>
          <ul className="listeVarie">
            <li>Progetto <a href="https://www.cnr.it/sites/default/files/public/media/rassegna_stampa/Rep_Scienze_Il_sensore_che_protegge_chi_vive_in_zone_isolate_12-12-2019.pdf">"Social Tech Care"</a></li>
            ...
            <li>Esposizione del progetto alla <a href="https://www.bright-night.it/">"Notte dei Ricercatori"</a> al CNR di Pisa il 28 settembre 2018</li>
